...
<html>
<head> 
  <title>management da-resord</title>
  <meta>
...
<body> 
  <div class="top">
    ...
    <div class="copy-top cf">
      ...
      <h2>Staf Resto<span>.</span></h2>
    </div>

    <div class="btn-top">
      <a href="#rekap">Lihat Rekap Restoran</a>
      <a href="{{ url('pesanan') }}">Ubah Status Pesanan</a>
    </div>
  </div>
  ...
  <footer>
    ...
    <div class="foot">
      ...
      <ul>
        ...
        <li><a href="{{ url('resto') }}">Profil</a></li>
